...
public class TalkingCharacter extends MoveableCharacter {
	/**
	 * 
	 * A TalkingCharacter is a MoveableCharacter that has a Head.png in it's
	 * resource folder.
	 * 
	 ...
	 */
	public TalkingCharacter(String name, String charFolder, Coordinate2D anchorLocation, Size size,
